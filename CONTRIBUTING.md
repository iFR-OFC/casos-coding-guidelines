...
# Contributing to CaΣoS Coding Guidelines

Changes to this guidelines can be suggested as [pull request](https://github.com/iFR-OFC/casos-coding-guidelines/compare).
